...
$databases = array (
  ...
  array (
    'default' => 
    array (
      'database' => 'povcon_drupal',
      'username' => 'povcon_user',
      'password' => 'pclg29',
      'host' => 'localhost',
      'port' => '',
      'driver' => 'mysql',
 ...
 *
 */
$drupal_hash_salt = 'JiCOIlST9Gd4SRbVM_znZLfyGDzC5TjkVjCPYXZujrw';
...
if (isset($_ENV['AH_SITE_ENVIRONMENT']) && $_ENV['AH_SITE_ENVIRONMENT'] === 'prod') { 
  $base_url = 'https://www.povertyandconservation.info';
}
...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/povcon/povcon-settings.inc');
}
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_povcon_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_povcon_dev_default.inc';
}
// </DDSETTINGS>
